            ...
            <div class="col-sm-12 text-center">
                <?php if($order->payment_method != 'card'):?>
                    ...
                    <div class="row">
                        ...
                        <?php else:?>
                            <h3>Благодарим за заказ! Мы свяжемся с Вами в ближайшее время.</h3>
                        <?php endif;?>
                    </div>
                <?php else:?>
                    ...
                    <?php if($order->payment == 'succeeded'):?>
                        ...
                        <div class="row">
                            <?php if($order->user_id):?>
                                <h3>Благодарим за заказ! Подробную информацию можно посмотреть в личном кабинете.</h3>
                                <?php if($order->email):?>
                                    <h3>После отправки заказы мы пришлем Вам письмо на указанную электронную почту.</h3>
                                <?php endif;?>
                            <?php elseif($order->email):?>
                                <h3>Благодарим за заказ! После отправки мы пришлем Вам письмо </h3>
                                <h3>на указанную электронную почту.</h3>
                            <?php else:?>
                                <h3>Благодарим за заказ! Мы свяжемся с Вами в ближайшее время.</h3>
                            <?php endif;?>
                        </div>
