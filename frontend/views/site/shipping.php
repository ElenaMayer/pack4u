    ...
    <div class="container">
        <div class="row about">
            <div class="col-sm-12">
                ...
                <h1>Доставка по России и миру</h1>

                <p><i class="fa fa-angle-right"></i>Доставка осуществляется Почтой России или транспортной компанией после <b>100% оплаты</b> товара.</p>
